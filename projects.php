           ...
           <div class="container">
                <div class="row">
                    <div class="col-lg-3 mb-4">
                        <img class="img-fluid rounded" width="306" height="140" loading="lazy" src="/assets/imgs/projects/topysale.webp" alt="<?php getContent("yellaDev", "common"); ?> - <?php getContent("projects", "common"); ?> - 1">
