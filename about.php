...
<body class="pt-0">
    ...
    <main>
        ...
        <section class="py-5 my-5">
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 text-center mb-4 mb-lg-0 wow animate__animated animate__fadeIn" data-wow-duration="2s" data-wow-delay=".2s">
                    ...
                    <div class="col-lg-6 wow animate__animated animate__fadeIn"  data-wow-duration="2s" data-wow-delay=".2s">
