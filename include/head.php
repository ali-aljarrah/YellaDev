...
<head>
    <style>
        ...
        .shapes {
            ...
            height: 48.496px;
            position: relative;
            background: conic-gradient(from 120deg at 50% 64%, #0000, #8f8888 1deg 120deg, #0000 121deg);
            transform-origin: 50% 50%;
            animation: 1.5s cubic-bezier(.3, 1, 0, 1) infinite shapes-b3u1dgmd;
        }
        ...
        .shapes:before {
            ...
            animation: 1.5s infinite shapes-ki907omd
        }
        ...
        @keyframes shapes-ki907omd {
            ...
            30%,
            70% {
                transform: rotate(calc(var(--s, 1)*120deg)) translate(calc(var(--s, 1)*-5.6px), 11.2px)
            }
        }
    </style>
    <meta charset="UTF-8">
