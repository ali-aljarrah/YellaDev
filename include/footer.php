<!-- <footer>
    <div class="container">
        ...
        <div class="row">
            <div class="col-lg-6  mb-4 mb-lg-0">
                <div class="text-white">&copy; <?php getContent("copyright", "common"); ?> <?php getContent("yellaDev", "common"); ?> <span id="footer-date"></span>.</div>
            </div>
            <div class="col-lg-6 text-center text-lg-end">
                <div class="d-flex justify-content-end align-items-end h-100">
                    <a class="text-white fs-14" href="/privacy_policy">Privacy Policy</a>
                    <div class="mx-3"></div>
                    <a class="text-white fs-14" href="/terms_and_conditions">Terms and Conditions</a>
                </div>
            </div>
        </div>
    </div>
