        ...
        <div class="row">
            ...
            <div class="col-lg-3 col-12 mt-4 mb-3 mt-lg-0 mb-lg-0">
                ...
                <p class="d-flex mb-1">
                    ...
                    <a href="tel:<?php echo PHONE_NUMBER; ?>" class="site-footer-link">
                ...
                <p class="d-flex">
                    ...
                    <a href="mailto:<?php echo EMAIL_ADDRESS; ?>" class="site-footer-link">
            ...
            <div class="col-lg-5 col-12">
                ...
                <ul class="social-icon <?php echo $iconPos; ?>">
                    <li class="social-icon-item mx-3">
                        <a href="https://www.facebook.com/share/16HSp4Yr3B/" target="_blank" aria-label="Facebook Account">
                    ...
                    <li class="social-icon-item mx-3">
                        <a href="https://www.instagram.com/yelladev.25/" target="_blank" aria-label="Instgram Account">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#000000" class="bi bi-instagram" viewBox="0 0 16 16">
                    ...
                    <li class="social-icon-item mx-3">
                        <a href="https://wa.me/<?php echo PHONE_NUMBER; ?>" target="_blank" aria-label="Whatsapp Account">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#000000" class="bi bi-whatsapp" viewBox="0 0 16 16">
                    ...
                    <li class="social-icon-item mx-3">
                        <a href="https://www.linkedin.com/company/yelladev/" target="_blank" aria-label="LinkedIn Account">
                            <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="#000000" class="bi bi-linkedin" viewBox="0 0 16 16">
            ...
            <div class="col-lg-6 text-center text-lg-end mt-2 mt-lg-4 mb-lg-0 mb-5">
                <div class="d-flex justify-content-start justify-content-lg-end align-items-end h-100">
                    <a class="copyright-text fs-14" href="/privacy_policy" aria-label="Privacy Policy"><?php getContent("privacy_policy", "common"); ?></a>
                    <div class="mx-3"></div>
                    <a class="copyright-text fs-14" href="/terms_and_conditions" aria-label="Terms and Conditions"><?php getContent("terms_and_conditions", "common"); ?></a>
                </div>
            </div>
        </div>
</footer>
