            ...
            <div class="container">
                <div class="row">
                    ...
                    <div class="col-lg-4 mt-3">
                            <div class="card ms-auto me-auto card-width" data-wow-delay=".6s">
                                <div class="card-body">
                                    <div class="title-box mb-4 mt-sm-0 mt-3">
                                        <div class="z-index-111 position-relative">
                                            <svg width="40" height="40" fill="currentColor" class="bi bi-whatsapp" viewBox="0 0 16 16">
                                        ...
                                        <div class="box-circle-large bg-ligh-orange"></div>
                                    </div>
                                    <h5 class="fs-20">Whatsapp</h5>
                                    <a href="#" target="_blank" rel="noopener">
                                        <p class="d-flex mb-0">
                                            <a href="tel:<?php echo PHONE_NUMBER; ?>" class="text-white mb-0 site-footer-link">
                    ...
                    <div class="col-lg-4 mt-3">
                            <div class="card ms-auto me-auto card-width" data-wow-delay=".6s">
                                <div class="card-body">
                                    <div class="title-box mb-4 mt-sm-0 mt-3">
                                        <div class="z-index-111 position-relative">
                                            <svg  width="40" height="40" fill="currentColor" class="bi bi-envelope-at-fill" viewBox="0 0 16 16">
                                    ...
                                    <h5 class="fs-20">Email</h5>
                                    <a class="text-white" href="#" target="_blank" rel="noopener">
                                        <p class="d-flex mb-0">
                                            <a href="mailto:<?php echo EMAIL_ADDRESS; ?>" class="text-white site-footer-link">
                    ...
                    <div class="col-lg-4 mt-3">
                            <div class="card ms-auto me-auto card-width" data-wow-delay=".6s">
                                <div class="card-body">
                                    <div class="title-box mb-3 mt-sm-0 mt-3">
                                        <div class="z-index-111 position-relative">
                                             <img class="img-fluid rounded-4" width="100" height="100" loading="lazy" src="/assets/imgs/icon/qr.webp">
                                        </div>
                                    </div>
                                    <a href="#" target="_blank" rel="noopener">
                                        <p class="silver-color mb-0 fs-13">
                                            scan here
                                        </p>
                                    </a>
                            </div>
